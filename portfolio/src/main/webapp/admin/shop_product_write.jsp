...
<link rel="stylesheet" type="text/css" href="./css/shop_product_write.css?v=1">
</head>
<body>
<header>
...
<div class="shopdiv">
	...
	<ul class="shop_ul shop_ul4">
		<li>판매 유/무</li>
		<li>
			<label><input type="radio" checked name="sel"> 판매 시작</label>
			<label><input type="radio" name="sel"> 팬매 종료</label>
		</li>
	</ul>	
	<input type="hidden" name="scan" id="scan" value="Y">
	
	<ul class="shop_ul shop_ul4">
		<li>조기품절</li>
		<li>
			<label><input type="radio" name="sel2"> 사용</label>
			<label><input type="radio" name="sel2" checked> 미사용</label>
		</li>
	</ul>
	<input type="hidden" name="ssold" id="ssold" value="N">	
...
<script src="./js/shop_product_write.js?v=2"></script>
<script>
