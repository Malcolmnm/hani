...
<head>
<meta charset="UTF-8">
<link rel="stylesheet" type="text/css" href="./css/agree.css?v=2"></link>
<title></title>
</head>
<body>
	<div class="joinbox">
		...
		<div class="join_tep2"><input type="checkbox" id="ckall" onclick="allck()">베스트샵의 모든 약관을 확인하고 전체 동의 합니다.<a>(전체동의, 선택항목도 포함됩니다.)</a></div>
		<div class="join_tep2"><input type="checkbox" id="ck1">(필수)<a>이용약관</a><a>전체보기</a><a>></a></div>
		<div id="agree_box" class="join_notice"></div>
		
		<div class="join_tep2"><input type="checkbox" id="ck2">(필수)<a>개인정보 수집 및 이용</a><a>전체보기</a><a>></a></div>
